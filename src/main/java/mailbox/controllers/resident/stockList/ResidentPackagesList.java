...
public class ResidentPackagesList {
    ...
    private AllStockList stockList, packagesInList, packagesList;
    ...
    public void showPackagesData(){
        packagesInList = packagesList.getInStockListByRoom(currentResident.getRoomNumber());
